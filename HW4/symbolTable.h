...
public:
    SymbolTable();
    void debug(bool state);                              int depth();                                         void print(void (*printData)(void *));               void enter(std::string name);                        void leave();                                        void *lookup(std::string sym);                                                                            void *lookupGlobal(std::string sym);                                                                      bool insert(std::string sym, void *ptr);                                                                  bool insertGlobal(std::string sym, void *ptr);                                                            void applyToAll(void (*action)(std::string , void *));        // apply func to all symbol/data pairs in local scope
